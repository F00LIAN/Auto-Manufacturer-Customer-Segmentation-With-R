...
# Path to Excel File
cars = read_excel("D:/Fun R Projects/Auto-Manufacturer Customer Segmentation/survey cars.xlsx")
...
cluster.results = kmeans(x = X, centers = 3, iter.max=1000, nstart=100)
